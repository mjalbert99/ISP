...
set corners [list \
    "slow" $SLW_PDK_LIB $CCM_LIB $GAM_LIB \
    "typ"  $TYP_PDK_LIB $CCM_LIB $GAM_LIB \
    "fast" $FST_PDK_LIB $CCM_LIB $GAM_LIB \
]

foreach {corner_name corner_lib ccm_lib gam_lib} $corners {
    file mkdir ${END_DIR}/output/${corner_name}

    design -reset
    read_verilog src/C_CPU.v

    read_liberty -lib $ccm_lib
