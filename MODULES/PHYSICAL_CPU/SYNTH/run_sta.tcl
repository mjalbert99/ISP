set TOP "P_CPU"
set SDC_FILE "../constraints/p_cpu.sdc"


set corners [list \
    "slow"\
    "/root/Work/vlsi/pdks/pdk/nangate45/libs/NangateOpenCellLibrary_slow.lib" \
    "../../DPC/PNR/metals/DPC.lib" \
    "../../LSC/PNR/metals/LSC.lib" \
    "../../BLC/PNR/metals/BLC.lib" \
    "typ"\
...
foreach {corner_name std_lib dpc_lib lsc_lib blc_lib} $corners {
    ...
    # 2. Read the DPC macro library for this specific corner
    read_liberty $dpc_lib
    read_liberty $lsc_lib
    read_liberty $blc_lib
