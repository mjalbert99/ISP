...
initialize_floorplan -die_area {0 0 580 335} \
                     -core_area {10 10 570 325} \
...
place_macro -macro_name {sram1} -location {304 15} -orientation R0
place_macro -macro_name {sram0} -location {29 15} -orientation MY


# set_io_pin_constraint -pin_names {clk0 csb0 addr0 clk1 csb1 addr1} -region left:55-280
set_io_pin_constraint -pin_names {din0 clk0 csb0 addr0 clk1 csb1 addr1} -region top:100-405
set_io_pin_constraint -pin_names {dout1} -region bottom:260-328
