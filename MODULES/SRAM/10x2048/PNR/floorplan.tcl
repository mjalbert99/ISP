...
initialize_floorplan -die_area {0 0 370 725} \
                     -core_area {10 10 360 715} \
...
place_macro -macro_name {sram0} -location {60 390} -orientation MX
place_macro -macro_name {sram1} -location {60 20} -orientation R0
